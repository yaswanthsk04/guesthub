...
curl -H "Authorization: token ${GITHUB_TOKEN}" -L -o docker/grafana/provisioning/datasources/datasource.yml "https://raw.githubusercontent.com/yaswanthsk04/guesthub/v0.6.0/config/grafana/provisioning/datasources/datasource.yml"
curl -H "Authorization: token ${GITHUB_TOKEN}" -L -o docker/grafana/provisioning/dashboards/dashboard.yml "https://raw.githubusercontent.com/yaswanthsk04/guesthub/v0.6.0/config/grafana/provisioning/dashboards/dashboard.yml"
...
curl -H "Authorization: token ${GITHUB_TOKEN}" -L -o /usr/local/monitoring/setup-verify/verify-setup.sh "https://raw.githubusercontent.com/yaswanthsk04/guesthub/v0.6.0/scripts/setup/verify-setup.sh"
chmod +x /usr/local/monitoring/setup-verify/verify-setup.sh

# Download and setup verification service
curl -H "Authorization: token ${GITHUB_TOKEN}" -L -o /etc/init.d/verify-setup "https://raw.githubusercontent.com/yaswanthsk04/guesthub/v0.6.0/scripts/setup/verify-setup.service"
chmod +x /etc/init.d/verify-setup
/etc/init.d/verify-setup enable

curl -H "Authorization: token ${GITHUB_TOKEN}" -L -o docker/docker-compose.yml "https://raw.githubusercontent.com/yaswanthsk04/guesthub/v0.6.0/config/docker-compose.yml"
chmod 644 docker/docker-compose.yml
curl -H "Authorization: token ${GITHUB_TOKEN}" -L -o docker/prometheus/prometheus-config.yml "https://raw.githubusercontent.com/yaswanthsk04/guesthub/v0.6.0/config/prometheus-config.yml"
chmod 644 docker/prometheus/prometheus-config.yml
curl -H "Authorization: token ${GITHUB_TOKEN}" -L -o docker/loki/loki-config.yml "https://raw.githubusercontent.com/yaswanthsk04/guesthub/v0.6.0/config/loki-config.yml"
chmod 644 docker/loki/loki-config.yml
curl -H "Authorization: token ${GITHUB_TOKEN}" -L -o docker/promtail/promtail-config.yml "https://raw.githubusercontent.com/yaswanthsk04/guesthub/v0.6.0/config/promtail-config.yml"
chmod 644 docker/promtail/promtail-config.yml
curl -H "Authorization: token ${GITHUB_TOKEN}" -L -o exporters/opennds-exporter.py "https://raw.githubusercontent.com/yaswanthsk04/guesthub/v0.6.0/services/opennds-exporter.py"
chmod 755 exporters/opennds-exporter.py

# Setup OpenNDS exporter service
echo "Setting up OpenNDS exporter service..."
curl -H "Authorization: token ${GITHUB_TOKEN}" -L -o /etc/init.d/opennds-exporter "https://raw.githubusercontent.com/yaswanthsk04/guesthub/v0.6.0/services/opennds-exporter.service"
...
curl -H "Authorization: token ${GITHUB_TOKEN}" -L -o /usr/local/monitoring/update-system/update-checker.py "https://raw.githubusercontent.com/yaswanthsk04/guesthub/v0.6.0/scripts/update/update-checker.py"
chmod 755 /usr/local/monitoring/update-system/update-checker.py

curl -H "Authorization: token ${GITHUB_TOKEN}" -L -o /etc/init.d/update-checker "https://raw.githubusercontent.com/yaswanthsk04/guesthub/v0.6.0/scripts/update/update-checker.service"
chmod 755 /etc/init.d/update-checker

curl -H "Authorization: token ${GITHUB_TOKEN}" -L -o /usr/local/monitoring/update-system/executor.sh "https://raw.githubusercontent.com/yaswanthsk04/guesthub/v0.6.0/scripts/update/update-executor.sh"
